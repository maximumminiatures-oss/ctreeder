(function (root) {
  ...
  const PERSONALITY_TRAITS = [
    "Greedy", "Kind", "Mild-mannered", "Ambitious", "Cynical", "Empathetic", "Quick-tempered", "Meticulous", "Carefree", "Arrogant",
    "Stoic", "Playful", "Resilient", "Vindictive", "Optimistic", "Secretive", "Charismatic", "Anxious", "Altruistic", "Blunt",
    "Deceitful", "Patient", "Impulsive", "Loyal", "Jealous", "Resourceful", "Timid", "Boastful", "Compassionate", "Moody",
    "Gregarious", "Self-disciplined", "Spiteful", "Generous", "Absent-minded", "Bold", "Neurotic", "Whimsical", "Ruthless", "Humble",
    "Paranoid", "Sincere", "Aloof", "Inquisitive", "Callous", "Affectionate", "Hot-headed", "Prudent", "Fickle", "Tenacious",
    "Melodramatic", "Easygoing", "Vain", "Honorable", "Pessimistic", "Witty", "Clingy", "Observant", "Domineering", "Forgiving",
    "Petty", "Courageous", "Lazy", "Gracious", "Sarcastic", "Idealistic", "Hedonistic", "Level-headed", "Combative", "Considerate",
    "Reckless", "Analytical", "Gullible", "Outgoing", "Suspicious", "Selfless", "Stubborn", "Gentle", "Tactless", "Dedicated",
    "Calculating", "Nonchalant", "Cowardly", "Cheerful", "Spontaneous", "Pompous", "Tolerant", "Controlling", "Creative", "Narrow-minded",
    "Reliable", "Hypocritical", "Diplomatic", "Impatient", "Warmhearted", "Envious", "Insightful", "Obstinate", "Modest", "Passive-aggressive",
    "Adaptable", "Overcritical", "Devoted", "Belligerent", "Open-minded", "Prejudiced", "Diligent", "Superstitious", "Dutiful", "Resentful",
    "Affable", "Conceited", "Cooperative", "Evasive", "Fearless", "Quarrelsome", "Perceptive", "Flamboyant", "Unwavering", "High-strung",
    "Broad-minded", "Thoughtful", "Bossy", "Pragmatic", "Melancholic", "Sociable", "Rigid", "Genuine", "Courteous", "Haughty",
    "Trusting", "Coarse", "Plucky", "Self-absorbed", "Honest", "Opportunistic", "Energetic", "Sheepish", "Dispassionate", "Cautious",
    "Abrasive", "Vibrant", "Malicious", "Lighthearted", "Punctual", "Touchy", "Earnest", "Decisive", "Hostile", "Sympathetic",
    "Snobbish", "Unassuming", "Good-natured", "Shallow", "Conscientious", "Overbearing", "Free-spirited", "Disloyal", "Persistent", "Slovenly",
    "Self-reliant", "Dogmatic", "Candid", "Frivolous", "Soft-spoken", "Rebellious", "Chivalrous", "Self-conscious", "Audacious", "Indecisive",
    "Warm-hearted", "Grumpy", "Enthusiastic", "Insecure", "Methodical", "Resigned", "Gallant", "Sensible", "Sullen", "Fanatical",
    "Unpretentious", "Treacherous", "Dynamic", "Flustered", "Big-hearted", "Venomous", "Calm", "Zealous"
  ];

  const TERRAIN_FEATURES = {
    G: [
      "Razor meadows", "Collapsed hyperloops", "City mounds", "Solar markers", "Steam tractors", "Hive pods", "Wind turbines", "Grazing herds",
      "Irrigation dikes", "Silo clusters", "Iron railheads", "Sod dugouts", "Fence grids", "Survey probes", "Burial cairns", "Seed vaults",
      "Thresher husks", "Buried cul-de-sacs", "Pasture fences", "Relay towers"
    ],
    D: [
      "Vitrified glass", "Titanium ribs", "Salt basins", "Moisture harvesters", "Mirage drones", "Solar fields", "Dune rails", "Buried stadiums",
      "Sand sails", "Scrapped convoys", "Sunken aqueducts", "Dust refineries", "Wind traps", "Plasma craters", "Hermit bunkers", "Silicon sands",
      "Ceramic pillars", "Heat sinks", "Nomad camps", "Radar arrays"
    ],
    F: [
      "Overgrown suburbs", "Mega anthills", "Bioluminescent groves", "Nano canisters", "Feral harvesters", "Ruined mills", "Ancient cedars",
      "Canopy walkways", "Iron snares", "Logging drones", "Strangled roads", "Timber fortresses", "Gene-mod flora", "Buried silos",
      "Spore clearings", "Charcoal kilns", "Rooted cars", "Mossy statues", "Ranger towers", "Hollow trunks"
    ],
    S: [
      "Chemical deltas", "Mangrove overpasses", "Methane geysers", "Barrier emitters", "Med-transporters", "Steam pumps", "Toxic sumps",
      "Reed mazes", "Submerged cars", "Slag peat", "Dredge platforms", "Pipe networks", "Slime sinks", "Rusted barges", "Stilt shanties",
      "Filter pods", "Ooze pools", "Sulfur vents", "Gas vents", "Hydrofoil hulks"
    ],
    H: [
      "Terraced ridges", "Hollow barrows", "Scree slopes", "Overgrown bunkers", "Signal mounds", "Wind turbines", "Antigrav pylons",
      "Hidden airlocks", "Crag watchtowers", "Stone cairns", "Iron mineheads", "Stepped knolls", "Buried vaults", "Cable lines",
      "Microwave relays", "Fossilized roads", "Radar dishes", "Grassy trenches", "Shard cliffs", "Drainage tunnels"
    ],
    M: [
      "Mag-rail chasms", "Thermal caverns", "Glaciated spires", "Sky observatories", "Levitating husks", "Defense sentinels", "Steam mines",
      "Avalanche gates", "Hydro-dams", "Telecom masts", "Lava tubes", "Geothermal vents", "High redoubts", "Cableway stations", "Drone aeries",
      "Missile silos", "Weather arrays", "Shattered passes", "Ore smelters", "Monorail bridges"
    ],
    O: [
      "Plastic reefs", "Ship breakers", "Submerged highways", "Holo-buoys", "Desalination vaults", "Hydro-turbines", "Glass beaches",
      "Sunk harbors", "Sea walls", "Tidal generators", "Rusted docks", "Oil derricks", "Hovercraft wrecks", "Sub pen", "Salt pans",
      "Concrete pilings", "Beacon towers", "Coral hulls", "Mudflats", "Amphibious tractors"
    ],
    L: [
      "Plastic reefs", "Ship breakers", "Submerged highways", "Holo-buoys", "Desalination vaults", "Hydro-turbines", "Glass beaches",
      "Sunk harbors", "Sea walls", "Tidal generators", "Rusted docks", "Oil derricks", "Hovercraft wrecks", "Sub pen", "Salt pans",
    ...
    W: [
      "Rad flats", "Ash basins", "Ionized craters", "Nuclear bulldozers", "Forcefield domes", "Lead casks", "Acid pools", "Fused bedrock",
      "Slag heaps", "Fallout drifts", "Slagged refineries", "Quarantine fences", "Decon showers", "Reactor husks", "Heavy lifters",
      "Hazard pillars", "Scorched skeletons", "Sputtering shields", "Toxic fumaroles", "Scrapyard canyons"
    ],
    R: [
      "Intact skyscrapers", "Subway catacombs", "Transit plazas", "Holo-billboards", "Concierge bots", "Timber catapults", "Ruined suburbs",
      "Multi-level malls", "Highway loops", "Server vaults", "Traffic drones", "Banking towers", "Barricaded lobbies", "Hospital wings",
      "Shattered skybridges", "Police droids", "Collapsed domes", "Escalator slopes", "Rubble avenues", "Generator basements"
    ]
  };
  ...
  function chooseUnique(values, count, roll, label) {
    const pool = uniqueNicknames(values);
    const selected = [];

    while (selected.length < count && pool.length > 0) {
      const choiceRoll = roll.die(pool.length, `${label} ${selected.length + 1}`);
      selected.push(pool.splice(choiceRoll.result - 1, 1)[0]);
    }
  ...
  function generateNpcRecord(roll, options) {
    ...
    const personality = chooseUnique(PERSONALITY_TRAITS, 2, roll, `${settings.role || "NPC"} personality trait`);
  ...
  function formatNpcRecord(npc, role) {
    ...
    return [
      ...
      classLine,
      npc.personality && npc.personality.length ? `Personality: ${npc.personality.join(", ")}` : "",
  ...
  function isOceanCoast(hex, map) {
    if (hex.terrain !== "O") {
      return false;
    }

    return HEX_DIRECTIONS.some((direction) => {
      const neighbor = map.get(axialKey(hex.q + direction.q, hex.r + direction.r));
      return neighbor && neighbor.terrain !== "O";
    });
  }

  function assignHexFeatures(hexes, map, roll) {
    hexes.forEach((hex) => {
      if (hex.terrain === "O" && !isOceanCoast(hex, map)) {
        hex.features = [];
        return;
      }

      hex.features = chooseUnique(TERRAIN_FEATURES[hex.terrain] || [], 2, roll, `Hex ${hex.q},${hex.r} terrain feature`);
    });
  }
  ...
  function topSettlementHexes(hexes, count) {
    return hexes
      .filter((hex) => hex.settlementInfo)
      .slice()
      .sort((a, b) => {
        const populationDifference = b.settlementInfo.population - a.settlementInfo.population;
        if (populationDifference !== 0) {
          return populationDifference;
        }
        return axialKey(a.q, a.r).localeCompare(axialKey(b.q, b.r));
      })
      .slice(0, count);
  }

  function populationReport(hexes) {
    const ranked = topSettlementHexes(hexes, 10).map((hex, index) => ({
      rank: index + 1,
      q: hex.q,
      r: hex.r,
      terrainName: hex.terrainName,
      settlement: hex.settlementInfo
    }));

    return {
      ranked,
      ranksByKey: new Map(ranked.map((entry) => [axialKey(entry.q, entry.r), entry.rank])),
      output: [
        "Population Report: 10 largest settlements",
        "",
        ...(ranked.length
          ? ranked.map((entry) => `${entry.rank}. ${entry.settlement.type} - ${entry.settlement.population} people - Tech ${entry.settlement.tech} - ${entry.settlement.faction} - ${entry.terrainName} (${entry.q},${entry.r})`)
  ...
  function generateHexMap() {
    ...
    assignHexFeatures(hexes, map, roll);
    return { output: summarizeHexMap(hexes, oceanPlan), log, hexes, oceanPlan };
  }

  function renderHexMap(container, metaElement, hexes, openPopup, closePopup, playerPosition, reportRanks) {
    ...
    positions.forEach((hex) => {
      ...
      const settlementText = hex.settlementInfo
        ...
        : "";
      const featureText = hex.features && hex.features.length ? `; features ${hex.features.join(", ")}` : "";
      ...
      title.textContent = `${hex.q},${hex.r}: ${hex.terrainName}; radiation ${hex.radiation ? "yes" : "no"}; settlement ${hex.settlement ? "yes" : "no"}; encounter ${hex.encounter ? "yes" : "no"}; forage ${hex.forage}${featureText}${settlementText}${radiationText}`;
      ...
      const reportRank = reportRanks ? reportRanks.get(axialKey(hex.q, hex.r)) : null;
      if (reportRank) {
        const rankBadge = document.createElementNS("http://www.w3.org/2000/svg", "text");
        rankBadge.setAttribute("x", cx + 7.5);
        rankBadge.setAttribute("y", cy - 9.5);
        rankBadge.setAttribute("class", "hex-report-rank");
        rankBadge.textContent = String(reportRank);
        svg.appendChild(rankBadge);
      }
  ...
  function hexPopupContent(hex, action) {
    ...
    return {
      ...
      body: [
        ...
        `Ring: ${hex.ring}`,
        `Features: ${hex.features && hex.features.length ? hex.features.join(", ") : "Deep ocean"}`,
        `Forage: ${hex.forage}`,
  ...
  function generateNpc(options) {
    const log = [];
    const roll = createRoller(log);
    const npc = generateNpcRecord(roll, options || {});
    const output = formatNpcRecord(npc);
    return { output, log, npc };
  }
  ...
  const SAVE_KEYS = {
    npcs: "mcc-random-generator:npcs:v1",
    maps: "mcc-random-generator:maps:v1"
  };
  ...
  function loadSaves(kind) {
    if (!storageAvailable()) {
      return [];
    }

    try {
      const parsed = JSON.parse(root.localStorage.getItem(SAVE_KEYS[kind]) || "[]");
  ...
  function storeSaves(kind, saves) {
    if (!storageAvailable()) {
      throw new Error("Browser storage is unavailable.");
    }
    root.localStorage.setItem(SAVE_KEYS[kind], JSON.stringify(saves));
  }
  ...
  function npcSaveTitle(result, savedAt) {
    const npc = result.npc || {};
    const level = npc.level !== undefined ? npc.level : result.level;
    const levelText = level !== undefined ? `L${level}` : "NPC";
    return `${npc.name || "NPC"} (${levelText}) - ${timestampLabel(savedAt)}`;
  }

  function mapSaveTitle(result, savedAt) {
    const hexes = result.map && result.map.hexes ? result.map.hexes : [];
    const explored = hexes.filter((hex) => hex.explored).length;
    return `Map ${timestampLabel(savedAt)} - ${explored}/${hexes.length} explored`;
  }

  function selectedSave(selectElement, kind) {
    const id = selectElement.value;
    return loadSaves(kind).find((save) => save.id === id) || null;
  }

  function populateSaveSelect(selectElement, kind) {
    const saves = loadSaves(kind);
    const previous = selectElement.value;
    selectElement.replaceChildren();

    const placeholder = document.createElement("option");
    placeholder.value = "";
    placeholder.textContent = kind === "npcs" ? "Saved NPCs" : "Saved Maps";
    ...
    if (saves.some((save) => save.id === previous)) {
  ...
  function saveRecord(kind, record) {
    ...
    storeSaves(kind, saves);
  }

  function deleteSelectedSave(selectElement, kind) {
    const id = selectElement.value;
    if (!id) {
      return false;
    }
    storeSaves(kind, loadSaves(kind).filter((save) => save.id !== id));
    return true;
  }

  function init() {
    const generateButton = document.getElementById("generateNpc");
    const npcLevel = document.getElementById("npcLevel");
    ...
    const saveNpcButton = document.getElementById("saveNpc");
    const savedNpcs = document.getElementById("savedNpcs");
    const loadNpcButton = document.getElementById("loadNpc");
    ...
    const saveMapFromToolbarButton = document.getElementById("saveMapFromToolbar");
    const populationReportButton = document.getElementById("populationReport");
    ...
    let currentNpcResult = null;
    let currentPopulationReport = null;
    ...
    function renderCurrentHexMap() {
      ...
      renderHexMap(
        ...
        closePopup,
        playerPosition,
        currentPopulationReport ? currentPopulationReport.ranksByKey : null
      );
    }
    ...
    function hideHexMap() {
      ...
      currentHexMap = null;
      playerPosition = null;
      currentPopulationReport = null;
    }

    function refreshSaveControls() {
      populateSaveSelect(savedNpcs, "npcs");
      populateSaveSelect(savedMaps, "maps");
    }

    function showSaveError(error) {
      const message = error && error.message ? error.message : String(error);
      renderLog(logElement, [`Save error: ${message}`]);
      if (typeof root.alert === "function") {
        root.alert(`Save error: ${message}`);
      }
    }

    function saveCurrentMap() {
      if (!currentHexMap) {
        renderLog(logElement, ["Generate or load a map before saving."]);
        return;
      }
      ...
      try {
        const record = {
          id: saveId(),
          type: "map",
          title: mapSaveTitle({ map: currentHexMap }, savedAt),
          savedAt,
          map: currentHexMap,
          playerPosition
        };
        saveRecord("maps", record);
        refreshSaveControls();
        savedMaps.value = record.id;
        renderLog(logElement, [`Saved map: ${record.title}`]);
      } catch (error) {
        showSaveError(error);
      }
    }
    ...
    function runGenerator() {
      hideHexMap();
      const level = Math.max(0, Math.min(5, Number(npcLevel.value) || 0));
      const npc = generateNpc({ level });
      currentNpcResult = npc;
    ...
    populationReportButton.addEventListener("click", () => {
      if (!currentHexMap) {
        renderLog(logElement, ["Generate or load a map before running a population report."]);
        return;
      }

      currentPopulationReport = populationReport(currentHexMap.hexes);
      showPlainOutput(currentPopulationReport.output);
      renderLog(logElement, [`Population report ranked ${currentPopulationReport.ranked.length} settlements.`]);
      renderCurrentHexMap();
      hexPopupTitle.textContent = "Population Report";
      hexPopupRich.hidden = true;
      hexPopupRich.replaceChildren();
      hexPopupBody.hidden = false;
      hexPopupBody.textContent = currentPopulationReport.output;
      hexPopupBackdrop.hidden = false;
      hexPopup.setAttribute("open", "");
      addHistory(historyElement, currentPopulationReport.output);
    });
    saveNpcButton.addEventListener("click", () => {
      if (!currentNpcResult) {
        renderLog(logElement, ["Generate or load an NPC before saving."]);
        return;
      }
      ...
      try {
        const record = {
          id: saveId(),
          type: "npc",
          title: npcSaveTitle(currentNpcResult, savedAt),
          savedAt,
          output: currentNpcResult.output,
          log: currentNpcResult.log,
          npc: currentNpcResult.npc,
          level: currentNpcResult.npc ? currentNpcResult.npc.level : Number(npcLevel.value) || 0
        };
        saveRecord("npcs", record);
        refreshSaveControls();
        savedNpcs.value = record.id;
        renderLog(logElement, [`Saved NPC: ${record.title}`]);
      } catch (error) {
        showSaveError(error);
      }
    });
    loadNpcButton.addEventListener("click", () => {
      const record = selectedSave(savedNpcs, "npcs");
      if (!record) {
        return;
      }
      hideHexMap();
      ...
      if (record.level !== undefined) {
        npcLevel.value = String(record.level);
      }
      showPlainOutput(record.output);
      renderLog(logElement, [`Loaded NPC: ${record.title}`]);
      addHistory(historyElement, record.output);
    });
    deleteNpcButton.addEventListener("click", () => {
      try {
        deleteSelectedSave(savedNpcs, "npcs");
        refreshSaveControls();
      } catch (error) {
        showSaveError(error);
      }
    ...
    saveMapFromToolbarButton.addEventListener("click", saveCurrentMap);
    loadMapButton.addEventListener("click", () => {
      const record = selectedSave(savedMaps, "maps");
      if (!record || !record.map) {
        return;
      }
      closePopup();
      currentNpcResult = null;
      currentHexMap = record.map;
      playerPosition = record.playerPosition || { q: 0, r: 0 };
      currentPopulationReport = null;
      showPlainOutput(currentHexMap.output || summarizeHexMap(currentHexMap.hexes || [], currentHexMap.oceanPlan));
      renderLog(logElement, [
        `Loaded map: ${record.title}`,
        `Explored ${(currentHexMap.hexes || []).filter((hex) => hex.explored).length} of ${(currentHexMap.hexes || []).length} hexes.`
      ]);
      renderCurrentHexMap();
      hexMapPanel.hidden = false;
      hexMapPanel.classList.add("fullscreen");
      addHistory(historyElement, currentHexMap.output || record.title);
    });
    deleteMapButton.addEventListener("click", () => {
      try {
        deleteSelectedSave(savedMaps, "maps");
        refreshSaveControls();
      } catch (error) {
        showSaveError(error);
      }
